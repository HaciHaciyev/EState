...
import core.project.estate.infrastructure.exceptions.DataNotFoundException;
import core.project.estate.infrastructure.exceptions.InvalidDataArgumentException;
...
public class JDBCWrap {
    ...
    JDBCWrap(DataSource dataSource) {
     ...
     * @throws core.project.estate.infrastructure.exceptions.InvalidDataArgumentException if the specified type is not a valid wrapper type
     *
     * @example
     * <pre>
