package core.project.estate.infrastructure.util.containers;
...
public record Result<V, E extends Throwable>(V value,
    ...
    public String resultMessage() {
        return this.success ? "Operation successful." : "Operation failed with exception: " + this.throwable.getMessage();
    }
